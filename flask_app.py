...
@app.route("/")
def home():
    return render_template('index.html', subject="안녕하세요. 반갑습니다. 박무언입니다")
...
@app.route("/about")
def about():
    return render_template('busan1.html', subject="이혼 수")
...
@app.route("/show1")
def show1():
    return render_template('img_test1.html', image_file='img/i_1.jpg')
...
@app.route("/show2")
def show2():
    return render_template('img_test2.html', image_file='img/i_2.jpg')
